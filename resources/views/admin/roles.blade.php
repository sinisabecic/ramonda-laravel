            ...
            <div class="table table-responsive">
                <table class="display hover" id="dataTableRoles" width="100%"
                    ...
                    @foreach($roles as $role)
                        <tr class="row-user" data-id="{{ $role->id }}">
                            {{--                            <td>--}}
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.error) {
                                ...
                                $(".row-user[data-id=" + formData.id + "] .deleteRoleBtn").text("Deleted").attr("disabled", "disabled");
                                $(".row-user[data-id=" + formData.id + "] .editRoleBtn").fadeOut('slow');
                                ...
                                $(".row-user[data-id=" + formData.id + "] .deletedAt").text(timestamp);
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.error) {
                                ...
                                $(".row-user[data-id=" + formData.id + "] .restoreRoleBtn").text("Restored").attr("disabled", "disabled");
                            }
                        }
                    })
                }
